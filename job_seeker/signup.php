...
if (isset($_POST['user_register_btn'])) {
    ...
    $check_email = mysqli_query($conn, "SELECT id FROM users WHERE user_login_email = '$email'");
    ...
    $sql = "INSERT INTO users (user_register_frist_name, user_register_last_name, user_login_email, user_login_password, created_at) 

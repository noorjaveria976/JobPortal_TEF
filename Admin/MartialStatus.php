...
<title>Manage Marital Statuses</title>
...
<a href="EditMaritalStatusForm.php" class="btn btn-light btn-sm float-end">
...
<tbody>
<?php
$query = $conn->query("SELECT * FROM marital_status ORDER BY id DESC");
$i = 1;
...
<a class="dropdown-item edit-btn" href="EditMaritalStatusForm.php?id=<?php echo $row['id']; ?>">
...
document.querySelectorAll(".delete-btn").forEach(btn=>{
    btn.addEventListener("click", function(e){
        ...
        Swal.fire({
            title:'Are you sure?',
            text:"This marital status will be deleted!",
            icon:'warning',
            ...
            if(result.isConfirmed){
                window.location.href = "includes/DeleteMaritalStatus.php?id="+id;
            }
        });
    });
});
...
document.querySelectorAll(".status-btn").forEach(btn=>{
    btn.addEventListener("click", function(e){
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                window.location.href = "includes/ChangeMaritalStatus.php?id="+id;
            }
        });
    });
});
